...
Configuration is read from the file link:settings.ini.example[settings.ini] and link:settings.admin.ini.example[settings.admin.ini].
...
Simply execute the `app.py` and `app-admin.py`:
...
The port and host may be changed in link:settings.ini.example[settings.ini] and link:settings.admin.ini.example[settings.admin.ini].
